...
window.jscarousel = function (targetCarousel, config) {
  ...
  paginationContainer.style = 'position: absolute; bottom: 20px; left: 50%; transform: translate(-50%, 0);';
  ...
  if (config.noClone) {
    maxPage -= 2;
    maxLoop -= 2;
    targetCarousel.children[0].style = 'width: 100%; vertical-align: top; display: inline-block; white-space: pre-line;';
