...
function jscarousel(CarouselContainer, config) {
  ...
  function swipeMove(ev) {
    if (swipeStartXPosition !== null) {
      ItemsWrapper.style.webkitTransform = 'translateX(-' + (currentPage * containerWidth + (swipeStartXPosition - resolveMouseX(ev))) + 'px)';
      ItemsWrapper.style.MozTransform = 'translateX(-' + (currentPage * containerWidth + (swipeStartXPosition - resolveMouseX(ev))) + 'px)';
      ItemsWrapper.style.msTransform = 'translateX(-' + (currentPage * containerWidth + (swipeStartXPosition - resolveMouseX(ev))) + 'px)';
      ItemsWrapper.style.OTransform = 'translateX(-' + (currentPage * containerWidth + (swipeStartXPosition - resolveMouseX(ev))) + 'px)';
      ItemsWrapper.style.transform = 'translateX(-' + (currentPage * containerWidth + (swipeStartXPosition - resolveMouseX(ev))) + 'px)';
    }
  }
